...
<section class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--full-height mbr-section--bg-adapted mbr-parallax-background" id="header1-0" style="background-image: url(assets/images/bg.jpg);">
		...
		<div class="mbr-box__container mbr-section__container container">
			<div class="mbr-box mbr-box--stretched"><div class="mbr-box__magnet mbr-box__magnet--center-left">
				<div class="row"><div class=" col-sm-6">
					...
					<a class="mbr-buttons__btn btn btn-lg btn-gp animated fadeInUp delay" onclick=" window.open('https://play.google.com/store/apps/details?id=eu.qm.fiszki','_blank')">Pobierz z Google Play</a> 
...
<section class="mbr-section mbr-section--relative mbr-section--fixed-size mbr-background" id="content5-0" style="background-image: url(assets/images/bg-video.jpg);">
...
<section class="mbr-section" id="content1-1">
	<div class="mbr-section__container container mbr-section__container--last">
		<div class="row">
			<div class="mbr-article mbr-article--wysiwyg col-sm-8 col-sm-offset-2"><p>Szukamy osób ambitnych, chcących rozwinąć się w programowaniu (nie ograniczamy się do konkretnego języka), testowaniu (tak,	tu też jest czego się uczyć), grafice oraz zarządzaniu.</p><p>Uważasz, że się nadajesz?<br></p><p>Aplikuj już teraz! To nie boli (i jest darmowe)</p><p><br></p></div>
		</div>
	</div>
</section>
